                            ...
                            <div className="col-md-4 text-center animate-box">
                                <div className="services color-4">
                                    ...
                                    <div className="desc">
                                        ...
                                        <p>JavaScript, HTML5, CSS3, Sass, REACT.js, JSX, Redux, Hooks, Jest, Context API, Git, Github, Php, Java, Firebase, Firestore, Stripe, Ajax, npm, yarn, Heroku, Bootstrap, TypeScript...
                                        </p>
                                    </div>
                                </div>
                            </div>
